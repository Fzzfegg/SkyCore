...
@Override
    ...
    public float evaluate(MolangBytecodeEnvironment environment) throws MolangException {
        ...
        switch (this.operator) {
            ...
            case NULL_COALESCING:
                return left;
            default:
                throw new MolangException("Unknown operator: " + this.operator);
        }
    }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof BinaryOperationNode)) return false;
        BinaryOperationNode that = (BinaryOperationNode) o;
        if (!java.util.Objects.equals(this.operator, that.operator)) return false;
        if (!java.util.Objects.equals(this.left, that.left)) return false;
        if (!java.util.Objects.equals(this.right, that.right)) return false;
        return true;
    }

    @Override
    public int hashCode() {
        return java.util.Objects.hash(operator, left, right);
    }

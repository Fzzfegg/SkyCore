...
@Override
    ...
    public boolean equals(Object o) {
        ...
        if (!java.util.Objects.equals(this.iterations, that.iterations)) return false;
        if (!java.util.Objects.equals(this.body, that.body)) return false;
        return true;
    }

    @Override
    public int hashCode() {
        return java.util.Objects.hash(iterations, body);
    }

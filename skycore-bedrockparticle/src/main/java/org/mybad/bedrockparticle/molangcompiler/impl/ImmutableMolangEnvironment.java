...
@Override
    ...
    public boolean equals(Object o) {
        if (!(o instanceof ImmutableMolangEnvironment)) return false;
        ImmutableMolangEnvironment that = (ImmutableMolangEnvironment) o;
        if (!java.util.Objects.equals(this.environment, that.environment)) return false;
        return true;
    }

    @Override
    public int hashCode() {
        return java.util.Objects.hash(environment);
    }

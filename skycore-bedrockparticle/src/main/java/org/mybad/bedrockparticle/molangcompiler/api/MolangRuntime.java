package org.mybad.bedrockparticle.molangcompiler.api;

import org.mybad.bedrockparticle.molangcompiler.api.exception.MolangException;
import org.mybad.bedrockparticle.molangcompiler.api.exception.MolangRuntimeException;
import org.mybad.bedrockparticle.molangcompiler.api.object.ImmutableMolangObject;
import org.mybad.bedrockparticle.molangcompiler.api.object.MolangObject;
import org.mybad.bedrockparticle.molangcompiler.impl.MolangVariableStorage;
...
public class MolangRuntime implements MolangEnvironment {
    ...
    private static class EditBuilder implements MolangEnvironmentBuilder<MolangRuntime> {
        private final MolangRuntime runtime;
        private final MolangVariableStorage query;
        private final MolangVariableStorage global;
        private final MolangVariableStorage variable;

        EditBuilder(MolangRuntime runtime,
                    MolangVariableStorage query,
                    MolangVariableStorage global,
                    MolangVariableStorage variable) {
        ...
        public MolangEnvironmentBuilder<MolangRuntime> clearLibraries() {
            this.runtime.objects.values().retainAll(java.util.Arrays.asList(this.query, this.global, this.variable));
            return this;
        }

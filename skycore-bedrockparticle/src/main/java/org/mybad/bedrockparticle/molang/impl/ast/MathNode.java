...
import org.mybad.bedrockparticle.molang.impl.MolangUtil;
...
private static final float RADIANS_TO_DEGREES = (float) (180 / Math.PI);
    ...
    public void writeBytecode(MethodNode method, MolangBytecodeEnvironment env, @Nullable Label breakLabel, @Nullable Label continueLabel) throws MolangException {
        switch (this.function) {
            ...
            case CLAMP: {
                ...
                method.visitMethodInsn(Opcodes.INVOKESTATIC, "org/mybad/bedrockparticle/molang/impl/MolangUtil", "clamp", "(FFF)F", false);
                break;
            }
            case DIE_ROLL: {
                this.arguments[0].writeBytecode(method, env, breakLabel, continueLabel);
                ...
                this.arguments[1].writeBytecode(method, env, breakLabel, continueLabel);
                this.arguments[2].writeBytecode(method, env, breakLabel, continueLabel);
                method.visitMethodInsn(Opcodes.INVOKESTATIC, "org/mybad/bedrockparticle/molang/impl/MolangUtil", "dieRoll", "(IFF)F", false);
                break;
            }
            ...
            case HERMITE_BLEND: {
                this.arguments[0].writeBytecode(method, env, breakLabel, continueLabel);
                method.visitMethodInsn(Opcodes.INVOKESTATIC, "org/mybad/bedrockparticle/molang/impl/MolangUtil", "hermiteBlend", "(F)F", false);
                break;
            }
            case LERP: {
                this.arguments[0].writeBytecode(method, env, breakLabel, continueLabel);
                this.arguments[1].writeBytecode(method, env, breakLabel, continueLabel);
                this.arguments[2].writeBytecode(method, env, breakLabel, continueLabel);
                method.visitMethodInsn(Opcodes.INVOKESTATIC, "org/mybad/bedrockparticle/molang/impl/MolangUtil", "lerp", "(FFF)F", false);
                break;
            }
            case LERPROTATE: {
                this.arguments[0].writeBytecode(method, env, breakLabel, continueLabel);
                this.arguments[1].writeBytecode(method, env, breakLabel, continueLabel);
                this.arguments[2].writeBytecode(method, env, breakLabel, continueLabel);
                method.visitMethodInsn(Opcodes.INVOKESTATIC, "org/mybad/bedrockparticle/molang/impl/MolangUtil", "lerpRotate", "(FFF)F", false);
                break;
            }
            case MIN_ANGLE: {
                this.arguments[0].writeBytecode(method, env, breakLabel, continueLabel);
                method.visitMethodInsn(Opcodes.INVOKESTATIC, "org/mybad/bedrockparticle/molang/impl/MolangUtil", "wrapDegrees", "(F)F", false);
                break;
            }
            case RANDOM: {
                this.arguments[0].writeBytecode(method, env, breakLabel, continueLabel);
                this.arguments[1].writeBytecode(method, env, breakLabel, continueLabel);
                method.visitMethodInsn(Opcodes.INVOKESTATIC, "org/mybad/bedrockparticle/molang/impl/MolangUtil", "random", "(FF)F", false);
                break;
            }
            case RANDOM_INTEGER: {
                this.arguments[0].writeBytecode(method, env, breakLabel, continueLabel);
            ...
            case TRIANGLE_WAVE: {
                this.arguments[0].writeBytecode(method, env, breakLabel, continueLabel);
                this.arguments[1].writeBytecode(method, env, breakLabel, continueLabel);
                method.visitMethodInsn(Opcodes.INVOKESTATIC, "org/mybad/bedrockparticle/molang/impl/MolangUtil", "triangleWave", "(FF)F", false);
                break;
            }
        }
    }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof MathNode)) return false;
        MathNode that = (MathNode) o;
        if (!java.util.Objects.equals(this.function, that.function)) return false;
        if (!java.util.Objects.equals(this.arguments, that.arguments)) return false;
        return true;
    }

    @Override
    public int hashCode() {
        return java.util.Objects.hash(function, arguments);
    }

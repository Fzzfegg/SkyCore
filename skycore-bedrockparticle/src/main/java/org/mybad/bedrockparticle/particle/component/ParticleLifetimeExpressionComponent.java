...
public final class ParticleLifetimeExpressionComponent implements ParticleComponent {
    ...
    public static ParticleLifetimeExpressionComponent deserialize(JsonElement json) throws JsonParseException {
        ...
        return new ParticleLifetimeExpressionComponent(
                ParticleJsonTupleParser.getExpression(object, "expiration_expression", () -> ParticleLifetimeExpressionComponent.DEFAULT_EXPIRATION),
                ParticleJsonTupleParser.getExpression(object, "max_lifetime", () -> ParticleLifetimeExpressionComponent.DEFAULT_MAX_LIFETIME));
    }
}

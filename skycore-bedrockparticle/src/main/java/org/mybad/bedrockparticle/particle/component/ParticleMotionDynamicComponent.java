...
public final class ParticleMotionDynamicComponent implements ParticleComponent {
    ...
    public static ParticleMotionDynamicComponent deserialize(JsonElement json) throws JsonParseException {
        ...
        MolangExpression[] linearAcceleration = ParticleJsonTupleParser.getExpression(object, "linear_acceleration", 3, () -> new MolangExpression[]{
        ...
        MolangExpression linearDragCoefficient = ParticleJsonTupleParser.getExpression(object, "linear_drag_coefficient", () -> ParticleMotionDynamicComponent.DEFAULT_LINEAR_DRAG_COEFFICIENT);
        MolangExpression rotationAcceleration = ParticleJsonTupleParser.getExpression(object, "rotation_acceleration", () -> ParticleMotionDynamicComponent.DEFAULT_ROTATION_ACCELERATION);
        MolangExpression rotationDragCoefficient = ParticleJsonTupleParser.getExpression(object, "rotation_drag_coefficient", () -> ParticleMotionDynamicComponent.DEFAULT_ROTATION_DRAG_COEFFICIENT);

...
import org.mybad.bedrockparticle.particle.event.SoundParticleEvent;
import org.mybad.bedrockparticle.particle.event.SpawnParticleEvent;
...
public interface ParticleParser {
    ...
    static ParticleData parseParticle(JsonElement json) throws JsonParseException {
        String formatVersion = ParticleGsonHelper.getAsString(json.getAsJsonObject(), "format_version");

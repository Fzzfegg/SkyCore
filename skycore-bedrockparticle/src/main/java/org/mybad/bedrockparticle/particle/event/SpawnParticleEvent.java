...
public final class SpawnParticleEvent implements ParticleEvent {
    ...
    public static class Deserializer implements JsonDeserializer<SpawnParticleEvent> {
        ...
        public SpawnParticleEvent deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
            JsonObject jsonObject = ParticleGsonHelper.convertToJsonObject(json, "particle_effect");
            String effect = ParticleGsonHelper.getAsString(jsonObject, "effect");
            ParticleSpawnType type = parseType(ParticleGsonHelper.getAsString(jsonObject, "type"));
            MolangExpression expression = ParticleJsonTupleParser.getExpression(jsonObject, "pre_effect_expression", () -> null);

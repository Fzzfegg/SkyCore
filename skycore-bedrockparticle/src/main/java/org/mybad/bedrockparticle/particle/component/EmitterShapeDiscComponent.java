    ...
    public static EmitterShapeDiscComponent deserialize(JsonElement json) throws JsonParseException {
        ...
        if (jsonObject.has("plane_normal")) {
            ...
            if (planeJson.isJsonPrimitive()) {
                String plane = ParticleGsonHelper.convertToString(planeJson, "plane_normal");
                ...
                normal = ParticleJsonTupleParser.getExpression(jsonObject, "plane_normal", 3, () -> new MolangExpression[]{
                        MolangExpression.ZERO,
                        MolangExpression.of(1),
                        MolangExpression.ZERO
                });
        ...
        MolangExpression[] offset = ParticleJsonTupleParser.getExpression(jsonObject, "offset", 3, () -> new MolangExpression[]{
                MolangExpression.ZERO,
                MolangExpression.ZERO,
                MolangExpression.ZERO
        });

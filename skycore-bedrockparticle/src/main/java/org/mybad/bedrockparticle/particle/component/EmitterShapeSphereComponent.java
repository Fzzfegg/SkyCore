 ...
 * @since 1.0.0
 */
public final class EmitterShapeSphereComponent implements ParticleEmitterShape {
    ...
    public EmitterShapeSphereComponent(MolangExpression[] offset,
    ...
    public static EmitterShapeSphereComponent deserialize(JsonElement json) throws JsonParseException {
        ...
        MolangExpression[] offset = ParticleJsonTupleParser.getExpression(jsonObject, "offset", 3, () -> new MolangExpression[]{MolangExpression.ZERO, MolangExpression.ZERO, MolangExpression.ZERO});
        MolangExpression radius = ParticleJsonTupleParser.getExpression(jsonObject, "radius", () -> MolangExpression.of(1));
        boolean surfaceOnly = ParticleGsonHelper.getAsBoolean(jsonObject, "surface_only", false);

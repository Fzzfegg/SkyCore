...
public final class ParticleMotionParametricComponent implements ParticleComponent {
    ...
    public static ParticleMotionParametricComponent deserialize(JsonElement json) throws JsonParseException {
        ...
        MolangExpression[] relativePosition = ParticleJsonTupleParser.getExpression(object, "relative_position", 3, () -> null);
        MolangExpression[] direction = ParticleJsonTupleParser.getExpression(object, "direction", 3, () -> null);

...
public interface ModelProcessor {
     ...
     * 在整个模型渲染开始时回调。
     */
    default void onStart(Model model, MatrixStack stack) {
    }
     ...
     */
    default boolean beforeBone(Model model, ModelBone bone, MatrixStack stack) {
        return true;
    }
     ...
     * 骨骼渲染结束时回调。
     */
    default void afterBone(Model model, ModelBone bone, MatrixStack stack) {
    }

    /**
     * 整个渲染流程结束时回调。
     */
    default void onFinish(Model model, MatrixStack stack) {
    }
}

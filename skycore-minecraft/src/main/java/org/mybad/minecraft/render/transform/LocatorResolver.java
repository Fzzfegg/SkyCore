...
public final class LocatorResolver {
    ...
    public static float[] resolveLocatorPosition(Model model, String locatorName) {
    ...
    public static boolean resolveLocatorTransform(Model model, String locatorName, LocatorTransform out) {

...
final class ParticleRenderer {
    ...
    ParticleRenderer(ParticleAppearanceBillboardComponent billboard,
    ...
    void render(ActiveParticle particle, Minecraft mc, double camX, double camY, double camZ, float partialTicks) {
        float width = 1.0f;
        float height = 1.0f;
